...
class TypeLanguageDefinition extends GrammarDefinition<TypeLanguageProgram> {
  ...
  Parser<ConstructorSector> constructorDeclarations() => declaration().trim().plus()
    .map(ConstructorSector.new)
    .labeled('constr-declaration');

  /// fun-declarations ::= { declaration }
  Parser<FunctionSector> functionDeclarations() => declaration().trim().plus()
  ...
  Parser<TermArgument> termArgument() => seq2(
  ...
  Parser<Arguments> arguments() => [
    ...
    seq5(
      ...
      seq2(ref0(multiplicity).optional(), asterisk().trim()).map2((p0, p1) => p0).optional(),
      openingBracket().trim(),
      ref0(arguments).plus(),
      closingBracket().trim(),
    ...
    seq5(
      ...
      ref0(termArgument),
      closingParenthesis(),
    ).map5((p0, p1, p2, p3, p4) => SimpleArguments(p1, p3)), // ParenthesizedArgument
    ...
    seq4(
      ...
      ref0(termArgument),
    ).map4((p0, p1, p2, p3) => ConditionalArgument(p0, p2, p3)),
    // args ::= [ ! ] type-term
    ref0(termArgument),
  ].toChoiceParser()
  .labeled('args');
